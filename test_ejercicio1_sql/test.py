...
from ejercicio1_sql.MiGramaticaLexer import MiGramaticaLexer
from ejercicio1_sql.MiGramaticaParser import MiGramaticaParser

# === Entrada de prueba ===
input_text = "SELECT * FROM usuarios;"
