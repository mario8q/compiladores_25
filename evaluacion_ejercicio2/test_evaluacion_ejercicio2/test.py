...
from evaluacion_ejercicio2.WhileLangLexer import WhileLangLexer
from evaluacion_ejercicio2.WhileLangParser import WhileLangParser

# === Entrada de prueba ===
input_text = "i = 0;while (i < 10) {if (i == 5) {break;}i = i + 1;continue;}"
