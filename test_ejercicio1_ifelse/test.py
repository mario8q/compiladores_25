from antlr4 import *
import sys
sys.path.append('/workspaces/compiladores_25/ejercicio1_ifelse')
from ejercicio1_ifelse import MiGramaticaLexer
from ejercicio1_ifelse import MiGramaticaParser
