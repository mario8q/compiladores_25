...
from evaluacion_ejercicio1.IfElseLangLexer import IfElseLangLexer
from evaluacion_ejercicio1.IfElseLangParser import IfElseLangParser

# === Entrada de prueba ===
input_text = "a = 10;b = 20;if (a > b) {max = a;} else {if (a == b) {max = a;} else {max = b;}}"
